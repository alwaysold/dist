import{f as h,j as s,a}from"./index.897e4e8e.js";const t=({children:c,title:d,subtitle:r,headerslot:e,className:o="custom-class",bodyClass:l="p-6",noborder:i,titleClass:n="custom-class"})=>{const[m]=h();return s("div",{className:`
